...
If you want to make this repo easier to reuse, the highest-value follow-ups are:

1. add `requirements.txt` or `pyproject.toml`
2. add `.gitignore` entries for `keys.yaml`, `out/`, and local `ml/`
3. refresh the shell wrappers in `scripts/`
4. document expected result columns in the generated CSV files
